...
arg[0] = '/home/mka/opt/xscript/lua/luadist/5.1.5/_build/linux32x86/test/life-quick.lua'
table.remove(arg, 1)
return assert(loadfile '/home/mka/opt/xscript/lua/luadist/5.1.5/_build/linux32x86/test/life-quick.lua')(unpack(arg))
