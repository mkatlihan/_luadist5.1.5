...
arg[0] = '/home/mka/opt/xscript/lua/luadist/5.1.5/test/factorial.lua'
table.remove(arg, 1)
return assert(loadfile '/home/mka/opt/xscript/lua/luadist/5.1.5/test/factorial.lua')(unpack(arg))
