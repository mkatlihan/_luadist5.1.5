...
arg[0] = 'H:/opt/xscript/lua/luadist/5.1.5/_build/mingw32/test/life-quick.lua'
table.remove(arg, 1)
return assert(loadfile 'H:/opt/xscript/lua/luadist/5.1.5/_build/mingw32/test/life-quick.lua')(unpack(arg))
