...
local modules = {
  ['strict'] = '/Users/mka/opt/xscript/lua/luadist/5.1.5/etc/strict.lua';
}
...
arg[0] = '/Users/mka/opt/xscript/lua/luadist/5.1.5/_build/osx64x86/test/life-quick.lua'
table.remove(arg, 1)
return assert(loadfile '/Users/mka/opt/xscript/lua/luadist/5.1.5/_build/osx64x86/test/life-quick.lua')(unpack(arg))
