...
arg[0] = '/Users/mka/opt/xscript/lua/luadist/5.1.5/test/printf.lua'
table.remove(arg, 1)
return assert(loadfile '/Users/mka/opt/xscript/lua/luadist/5.1.5/test/printf.lua')(unpack(arg))
