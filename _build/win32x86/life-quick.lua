...
local modules = {
  ['strict'] = 'H:/opt/xscript/lua/luadist/5.1.5/etc/strict.lua';
}
...
arg[0] = 'H:/opt/xscript/lua/luadist/5.1.5/_build/win32x86/test/life-quick.lua'
table.remove(arg, 1)
return assert(loadfile 'H:/opt/xscript/lua/luadist/5.1.5/_build/win32x86/test/life-quick.lua')(unpack(arg))
