...
local modules = {
  ['strict'] = 'C:/opt/xscript/lua/luadist/5.1.5/etc/strict.lua';
}
...
arg[0] = 'C:/opt/xscript/lua/luadist/5.1.5/_build/win64x86/test/life-quick.lua'
table.remove(arg, 1)
return assert(loadfile 'C:/opt/xscript/lua/luadist/5.1.5/_build/win64x86/test/life-quick.lua')(unpack(arg))
